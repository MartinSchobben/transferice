...
To achieve this this package use the tidymodels metapackage, where seperate package deal with re-sampling, model fitting and evaluation.
...
The basic model constitutes thus a multivariate multiple regression model of matrix with $n$ dinocyst species and $m$ sites ($X$) and a matrix of $n$ oceanographic parameters and again $m$ sites ($Y$).
